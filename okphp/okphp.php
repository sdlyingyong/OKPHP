...
//框架根目录
defind('CORE_PATH') or define('CORE_PATH', __DIR__);

/**
 * okphp framework core
 * 框架核心.
 * 类自动加载
环境检查
过滤敏感字符
...
//    }
    ...
    public function run()
    {
        sql_autoload_register([$this,'loadClass']);
        $this->setReporting();
        $this->removeMagicQuotes();
    ...
    //检测敏感字符并删除
    //Detect sensitive characters and delete
